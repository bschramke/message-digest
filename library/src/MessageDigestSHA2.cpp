...
void MessageDigestSHA2::update(const void *data, const size_t offset, const size_t len)
{
...
void MessageDigestSHA2::processBlock(const void *data)
{
...
void MessageDigestSHA2::processBuffer()
{
